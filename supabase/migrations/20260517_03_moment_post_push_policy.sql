-- Reduce noisy Moment post push notifications.
-- Policy:
-- 1. Only the first Moment post in a short burst sends a push.
-- 2. Additional posts from the same author in that window stay in-feed only.
