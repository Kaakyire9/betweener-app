-- Betweener Live Phase 10E additive runtime hardening.
-- Keeps applied migration history immutable while updating the playback
-- eligibility and deterministic Show Director cleanup/audit boundaries.
