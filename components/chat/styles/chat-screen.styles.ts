...
import { createChatLocationStyles } from '@/components/chat/styles/chat-location.styles';
import { createChatMediaViewerStyles } from '@/components/chat/styles/chat-media-viewer.styles';
...
export const createChatScreenStyles = (
  ...
  return StyleSheet.create({
    ...
    header: {
      ...
      paddingVertical: 10,
      backgroundColor: withAlpha(theme.background, isDark ? 0.92 : 0.9),
      borderBottomWidth: 1,
      borderBottomColor: withAlpha(theme.tint, isDark ? 0.24 : 0.14),
    ...
    headerChromeGlow: {
      ...
      top: -54,
      borderRadius: 88,
      backgroundColor: withAlpha(theme.tint, isDark ? 0.09 : 0.055),
    },
    intentBanner: {
      marginHorizontal: 16,
      marginTop: 8,
    ...
    backButton: {
      ...
      backgroundColor: withAlpha(theme.backgroundSubtle, isDark ? 0.72 : 0.8),
    ...
    emojiOnlyMetaRow: {
      ...
      paddingVertical: 2,
      borderRadius: 999,
      backgroundColor: isDark ? 'rgba(3,20,20,0.68)' : 'rgba(255,250,245,0.88)',
    },
    messageTextInline: {
      flexShrink: 1,
    },
    ...
    inputContainer: {
      ...
      paddingTop: 8,
      paddingBottom: 10,
      backgroundColor: withAlpha(theme.background, isDark ? 0.82 : 0.88),
      borderTopWidth: 1,
      borderTopColor: withAlpha(theme.tint, isDark ? 0.2 : 0.12),
      shadowColor: theme.tint,
      shadowOffset: { width: 0, height: -6 },
      shadowOpacity: isDark ? 0.07 : 0.035,
      shadowRadius: 16,
      elevation: 4,
    },
    composerShell: {
      ...
      paddingVertical: 5,
      borderRadius: 20,
      backgroundColor: isDark ? withAlpha(theme.backgroundSubtle, 0.78) : withAlpha('#fffaf5', 0.86),
      borderWidth: 1,
      borderColor: withAlpha(theme.tint, isDark ? 0.23 : 0.14),
      shadowColor: Colors.dark.background,
      shadowOffset: { width: 0, height: 3 },
      shadowOpacity: isDark ? 0.09 : 0.04,
      shadowRadius: 12,
      elevation: 1,
    },
    ...
    mediaSurface: {
      backgroundColor: isDark ? '#10282A' : theme.backgroundSubtle,
    },
    messageImage: {
    ...
    ...createChatMediaViewerStyles(screenWidth, screenHeight),
    ...createChatLocationStyles(theme, isDark),
...
export type ChatScreenStyles = ReturnType<typeof createChatScreenStyles>;
