...
const ExploreStackReanimated = forwardRef<ExploreStackHandle, Props>(
  ({ matches, currentIndex, setCurrentIndex, recordSwipe, onProfileTap, previewingId }, ref) => {
          ...
          <GestureDetector gesture={pan}>
            <Animated.View style={{ flex: 1 }} pointerEvents="box-none">
              <Animated.View style={[styles.card, activeStyle]}>
                <ExploreCard match={m} onPress={() => onProfileTap(m.id)} isPreviewing={previewingId === m.id} />
              </Animated.View>
