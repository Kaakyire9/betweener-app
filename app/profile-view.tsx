...
const createStyles = (theme: typeof Colors.light, isDark: boolean) =>
  StyleSheet.create({
    ...
    profileName: { fontSize: 30, color: Colors.light.background, fontFamily: 'PlayfairDisplay_700Bold', letterSpacing: 0.5 },
    ...
    sectionTitle: { color: theme.text, fontSize: 18, fontFamily: 'PlayfairDisplay_600SemiBold', marginBottom: 10 },
